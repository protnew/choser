...
// ─── COUNCIL TABLE ───
  ...
  'table.averaged':     { en: 'Averaged',          ru: 'Усреднённая',     es: 'Promedio',        fr: 'Moyenne' },
  'table.chat':         { en: 'Chat',              ru: 'Чат',             es: 'Chat',            fr: 'Chat' },
  'table.publish':      { en: 'Publish',           ru: 'Публикация',      es: 'Publicar',        fr: 'Publier' },
  'table.aiDescription':{ en: 'AI Description',    ru: 'AI-описание',     es: 'Descripción IA',  fr: 'Description IA' },
  'table.shareLink':    { en: 'Share Link',        ru: 'Ссылка',          es: 'Enlace',          fr: 'Lien' },
  'table.preview':      { en: 'Preview',           ru: 'Превью',          es: 'Vista previa',    fr: 'Aperçu' },

...
const MIGRATIONS = [
  ...
  },
  {
    ...
    sql: `
      ALTER TABLE decision_tags ADD COLUMN winner TEXT;
      ALTER TABLE decision_tags ADD COLUMN score INTEGER;
      ALTER TABLE decision_tags ADD COLUMN tokens_input INTEGER DEFAULT 0;
      ALTER TABLE decision_tags ADD COLUMN tokens_output INTEGER DEFAULT 0;
    `
  },
  {
